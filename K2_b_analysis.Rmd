...
```{r ctopp boxplots, echo = FALSE, message = FALSE}
...
```{r ctopp scatterplots, echo = FALSE, message = FALSE}
...
```{r towre swe hist, echo = FALSE, message = FALSE}
# TOWRE_SWE 
...
```{r towre pde hist,  echo = FALSE, message = FALSE}
...
```{r towre swe boxplots, echo = FALSE}
...
```{r towre pde boxplots, echo = FALSE}
...
```{r towre boxplot figure, echo = FALSE, fig.height = 6}
...
### TOWRE Scatterplots
```{r towre swe scatterplots,  echo = FALSE, message = FALSE}
# SWE plots
...
```{r towre pde histograms,  echo = FALSE, message = FALSE}
...
```{r towre scatterplot figure, echo = FALSE, fig.height = 6}
# format plots
...
```{r wj plots, fig.width = 10, echo = FALSE}
...
corrplot(b_matrix, p.mat = b_test$p, sig.level = 0.05, insig = "label_sig", pch.col = "white")
```
